namespace Phantoms.Infrastructure.Templates;
...
<body>
  <div class=""container"">
    <div class=""header""><h1>Phantoms</h1></div>
    <div class=""body"">
    ...
    <div class=""footer"">&copy; {year} Phantoms. All rights reserved.</div>
  </div>
</body></html>";
    }
...
<body>
  <div class=""container"">
    <div class=""header""><h1>Welcome to Phantoms!</h1></div>
    <div class=""body"">
      <p>Hello <strong>{userName}</strong>,</p>
